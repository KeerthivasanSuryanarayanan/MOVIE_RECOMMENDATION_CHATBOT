...
Original file is located at
    https://colab.research.google.com/drive/1rjVDFuK2XupSHJVdF_CTo-fJuiFec8l5
"""
...
def draw_clusters(biased_dataset, predictions, cmap='viridis'):
    ...
    ax.set_ylabel('Avg crime rating')
    

    clustered = pd.concat([biased_dataset.reset_index(), pd.DataFrame({'group':predictions})], axis=1)
    plt.scatter(clustered['avg_scifi_rating'], clustered['avg_crime_rating'], c=clustered['group'], s=20, cmap=cmap)
...
def get_dataset_3(movies, ratings, genre_ratings):    
    ...
    genre_ratings_3.columns = ['avg_crime_rating', 'avg_scifi_rating', 'avg_action_rating']
    
    # Let's bias the dataset a little so our clusters can separate scifi vs romance more easily
    b1 = 3.2
    b2 = 2.5
    biased_dataset_3 = genre_ratings_3[((genre_ratings_3['avg_crime_rating'] < b1 - 0.2) & (genre_ratings_3['avg_scifi_rating'] > b2)) | ((genre_ratings_3['avg_scifi_rating'] < b1) & (genre_ratings_3['avg_romance_rating'] > b2))]
...
def bias_genre_rating_dataset(genre_ratings, score_limit_1, score_limit_2):
    biased_dataset = genre_ratings[((genre_ratings['avg_crime_rating'] < score_limit_1 - 0.2) & (genre_ratings['avg_scifi_rating'] > score_limit_2)) | ((genre_ratings['avg_scifi_rating'] < score_limit_1) & (genre_ratings['avg_crime_rating'] > score_limit_2))]
